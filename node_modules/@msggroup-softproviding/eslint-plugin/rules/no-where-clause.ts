...
export const requireWhereClause = createRule({
  ...
  meta: {
    ...
    docs: {
      description:
        "Require .where() method call after SELECT(...) and SELECT.from(...)",
    },
    fixable: undefined,
    schema: [],
    messages: {
...
function checkForWhereClause(node: TSESTree.CallExpression, context: any) {
...
function hasWhereInChain(node: TSESTree.Node): boolean {
