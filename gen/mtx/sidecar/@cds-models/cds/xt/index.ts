...
// enum
export const CSNConsumer = {
  nodejs: "nodejs",
  java: "java",
} as const;
export type CSNConsumer = "nodejs" | "java"
...
export function _CSNAspect<TBase extends new (...args: any[]) => object>(Base: TBase) {
  return class CSN extends Base {
    static readonly kind: 'entity' | 'type' | 'aspect' = 'type';
    declare static readonly keys: __.KeysOf<CSN>;
    declare static readonly elements: __.ElementsOf<CSN>;
    declare static readonly actions: globalThis.Record<never, never>;
  };
}
export class CSN extends _CSNAspect(__.Entity) {}
Object.defineProperty(CSN, 'name', { value: 'cds.xt.CSN' })
Object.defineProperty(CSN, 'is_singular', { value: true })

export function _I18NAspect<TBase extends new (...args: any[]) => object>(Base: TBase) {
  return class I18N extends Base {
    static readonly kind: 'entity' | 'type' | 'aspect' = 'type';
    declare static readonly keys: __.KeysOf<I18N>;
    declare static readonly elements: __.ElementsOf<I18N>;
    declare static readonly actions: globalThis.Record<never, never>;
  };
}
export class I18N extends _I18NAspect(__.Entity) {}
Object.defineProperty(I18N, 'name', { value: 'cds.xt.I18N' })
Object.defineProperty(I18N, 'is_singular', { value: true })
